...
sidebar_label: Trade Classification
description: "TradeMonkey automatically classifies your trades to apply the right rules, detect behavioral drift, and surface patterns without manual setup."
keywords: [trade classification, automatic tagging, trade categorization, behavioral patterns, rule application]
---
