...
You cannot edit or remove these.

These tags ensure every trade has minimum structure for analysis.
...
These tags are flexible.

You can add, remove, or rename them as your playbook evolves.
...
Avoid outcome-based or emotional labels  
...
Fix obvious errors (wrong session, wrong setup), but avoid rewriting history to match how you feel about the outcome.  
That distorts time-based and AI-driven patterns.
...
Thoughtful, consistent tagging is one of the highest-leverage habits in TradeMonkey.

The more clinically you describe your trades, the more precise your rules, analytics, and AI insights will be.
