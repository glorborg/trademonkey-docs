...
Before trading:  
Open calendar view or widget.  
Look at today's high-impact events and their windows.  
Mark restricted zones based on your rules (e.g. ±30 minutes).  
Decide whether to trade at all today and which hours are realistically "clean."

### 2. During Session: Guardrails Against Impulses

When a setup appears:  
Check time vs upcoming/ongoing events.  
Compare with your news rules (e.g. "no trades within 30 minutes of news").  
If inside a restricted window, you know this is a rule break, not just "a bit risky."

### 3. Post-Session: Review Trades Near Events

After trading:  
Open Rules vs Reality Dashboard.  
Filter for news-rule violations or trades tagged with news-window context.  
For each trade, review which event it was near, emotions, conviction, and outcome.  
...
If you have questions about Calendar & News Events or think something looks wrong, email [hello@trademonkey.app](mailto:hello@trademonkey.app).
