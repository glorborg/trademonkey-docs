...
Behavior patterns are recurring behaviors in your trading that show up across many trades, not just one. They connect your psychology, Rule Adherence, and outcomes to answer:

"What do I tend to do over and over, when executing my trading plan, and what does it usually lead to?"

## What This Feature Does

Behavior patterns combine multiple parts of your data:

Psychology – Emotional State, Conviction (1–10) scores, Plan Adherence.  
...
"Afternoon trades show lower Conviction (1–10) and lower Plan Adherence than morning trades."

Behavior patterns are descriptive, not rules. Rules are things you set ("Max 3 trades per day"). Patterns are things the system observes ("On days with a first-trade loss, you frequently trade more than 3 times").

## Where You'll See Behavior Patterns

Behavior patterns power several parts of the app:
...
Behavioral Recap  
Lets you visually confirm patterns across multiple trades (screenshots, Emotional State, Conviction (1–10), exits).

You won't see a "Patterns" tab by name; instead, patterns appear as clinical statements embedded in these views listed above.

## How to Get Meaningful Behavior Patterns in Your Trading Behavioral Data

Log complete data  
Record Emotional State, Conviction (1–10), Plan Adherence, and tags along with each trade at the time you placed the trade.  
The more complete your data, the more reliable the patterns.

Run your usual reviews  
...
Read pattern statements carefully  
Focus on what the pattern is, when it shows up, and how it differs from your rules and trading plan.  
...
Use patterns to inform adjustments to your rules, schedule, sizing, or strategies in other parts of your trading playbook.
...
All of these operate as a behavior dashcam: they document what occurred, not what you should do next. Once behavioral drift becomes visible, correction becomes possible.
...
Missing Emotional State, Conviction (1–10), or tags reduce what can be detected. Incomplete fields lead to weaker or fewer patterns.
...
If a pattern looks wrong or confusing, you can always cross-check it with your raw analytics. For help understanding what you're seeing, contact [hello@trademonkey.app](mailto:hello@trademonkey.app).
