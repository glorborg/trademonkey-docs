...
Some features (e.g. AI summaries, deep-dive analysis, rules vs. reality) use AI and may have daily usage limits that reset regularly.
...
Core tracking, rules, and analytics continue to work even if you've hit AI limits or choose not to use AI at all.
...
Pick a behavior mode that fits your personality (most traders start with a balanced/standard mode).

Decide whether you want email recaps and adjust nudge intensity up or down after a week of use.

Consider enabling reflection requirements only if you want strict accountability and don't take a large number of trades each day.
